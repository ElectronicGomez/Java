...
public class Trabajador {
    ...
    public Trabajador(String nombre, String apellidos, int edad, String empresa){
        this.nombre = nombre;
    ...
    public Trabajador(String nombre, String apellidos, int edad, String empresa, float sueldo){
        this.nombre = nombre;
        this.apellidos = apellidos;
        this.edad = edad;
        this.empresa = empresa;
    ...
    public void setSueldo(float newSueldo){ //void->no retorna nada
