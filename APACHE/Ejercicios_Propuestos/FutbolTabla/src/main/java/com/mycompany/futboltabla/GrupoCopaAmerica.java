...
public class GrupoCopaAmerica {
    ...
    private void generaResultados(){
        ...
        /*El grupo tiene 4 paises. Cada fecha son dos partidos. En total son 3 fechas
        Lo cual les dará un total de 6 partidos. Y en 6 partidos habrán 12 goles */
        int[] goles = new int[12];
        for(int i=0;i<12;i++){
            goles[i]=(int)(Math.random()*10);
        }
        //Fecha 1:
    ...
    public void mostrarTabla(){
        generaResultados();
        System.out.println("Puesto      País    PJ  PG  PE  PP  GF  GC      DIF     PTS");
